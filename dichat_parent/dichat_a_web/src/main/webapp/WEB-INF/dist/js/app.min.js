! function (e) {
    ...
    $('[data-toggle="tooltip"]').tooltip(), $(document).ready(function () {
        ...
        return $(this).tooltip("dispose"), $("body").hasClass("dark") ? ($("body").removeClass("dark"), $(this).attr("title", "Dark mode")) : ($("body").addClass("dark"), $(this).attr("title", "白天模式")), $(this).tooltip(), !1
        ...
        return $("#pageTour").modal("hide").on("hidden.bs.modal", function (e) {
            var o = new EnjoyHint({});
            o.set([{
                'next .sidebar>header>ul>li>[data-target="#addFriends"]': "您可以在这里添加好友.",
                'nextButton': {
                    className: "myNext",
                    text: "下一步"
                },
                ...
                'next [data-navigation-target="chats"]': "这里是消息列表，在这您可以与好友聊天.",
                'nextButton': {
                    className: "myNext",
                    text: "下一步"
                },
                ...
                'next [data-navigation-target="friends"]': "点击这里可以看到您的好友列表.",
                'nextButton': {
                    className: "myNext",
                    text: "下一步"
                },
                ...
                'next [data-navigation-target="favorites"]': "这里是好友对您的印象，您与您的好友的评价都在此展示.",
                'nextButton': {
                    className: "myNext",
                    text: "下一步"
                },
                ...
                'next [data-navigation-target="archived"]': "系统消息通知列表，例如：好友申请等等.",
                'nextButton': {
                    className: "myNext",
                    text: "下一步"
                },
                ...
                'next .dark-light-switcher': "点击这里可以切换昼夜主题，让您有更好的体验.",
                'nextButton': {
                    className: "myNext",
                    text: "下一步"
                },
                ...
                "next .navigation>.nav-group>ul>li.brackets+li+li": "这里可以修改您的个人信息和退出登录",
                'nextButton': {
                    className: "myNext",
                    text: "下一步"
                },
